module.exports = (config) => {
  ...
  const generalCommands = new Set(['menu', 'ping', 'help', 'session', 'vv', 'vv2', 'sticker', 'sticker2', 'img', 'movie', 'anime', 'alive', 'ttt', 'wcg', 'song', 'ytvideo', 'tiktok', 'yts', 'mediafire', 'apk', 'mp3', 'reverse', 'metallic', 'fire', 'neon', 'glitch', 'matrix', 'thunder', 'ice', 'snow', 'purple', 'devil', 'hacker', 'light', 'impressive', 'leaves', 'sand', 'blackpink', '1917', 'arena', 'wings', 'christmas1', 'christmas2', 'frost', 'deadpool', 'dbz', 'naruto', 'pixelglitch', 'arrow', 'kill', 'hug', 'kiss', 'slap', 'punch', 'party', 'winner', 'cry', 'bite', 'happy', 'pat', 'goon1', 'goon2']);
  const varCommands = new Set(['autoviewonce', 'setvar', 'mode', 'prefix', 'ownernumber', 'seevar', 'antidelete', 'wapresence', 'left', 'setsudo', 'delsudo', 'seesudo', 'otplock']); // Commands that modify global .env settings
